...
(cl:defmethod cl:initialize-instance :after ((m <img_srv-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'img_srv-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pkg_why-srv:<img_srv-request> is deprecated: use pkg_why-srv:img_srv-request instead.")))

(cl:ensure-generic-function 'color-val :lambda-list '(m))
(cl:defmethod color-val ((m <img_srv-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pkg_why-srv:color-val is deprecated.  Use pkg_why-srv:color instead.")
  (color m))

(cl:ensure-generic-function 'point-val :lambda-list '(m))
(cl:defmethod point-val ((m <img_srv-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pkg_why-srv:point-val is deprecated.  Use pkg_why-srv:point instead.")
  (point m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<img_srv-request>)))
  ...
  "b8f81b07fa9e42ef3be27169c18c00a1")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'img_srv-request)))
  "Returns md5sum for a message object of type 'img_srv-request"
  "b8f81b07fa9e42ef3be27169c18c00a1")
...
(cl:defmethod cl:initialize-instance :after ((m <img_srv-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'img_srv-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pkg_why-srv:<img_srv-response> is deprecated: use pkg_why-srv:img_srv-response instead.")))

(cl:ensure-generic-function 'response-val :lambda-list '(m))
(cl:defmethod response-val ((m <img_srv-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pkg_why-srv:response-val is deprecated.  Use pkg_why-srv:response instead.")
  (response m))
