...
if("TRUE" STREQUAL "TRUE")
  set(test_SOURCE_PREFIX /home/yellow/catkin_ws_test/src/test)
  set(test_DEVEL_PREFIX /home/yellow/catkin_ws_test/devel)
  set(test_INSTALL_PREFIX "")
  set(test_PREFIX ${test_DEVEL_PREFIX})
else()
  set(test_SOURCE_PREFIX "")
  set(test_DEVEL_PREFIX "")
  set(test_INSTALL_PREFIX /home/yellow/catkin_ws_test/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'test' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/yellow/catkin_ws_test/src/test/${idir}'.  ${_report}")
    endif()
    _list_append_unique(test_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "nctu_gui")
...
set(depends "roscpp;rospy;std_msgs;subt_msgs")
