...
echo_and_run cd "/home/yellow/catkin_ws_test/src/vision_opencv/image_geometry"
...
echo_and_run /usr/bin/env \
    ...
    "/home/yellow/catkin_ws_test/src/vision_opencv/image_geometry/setup.py" \
     \
    build --build-base "/home/yellow/catkin_ws_test/build/vision_opencv/image_geometry" \
    install \
    --root="${DESTDIR-/}" \
