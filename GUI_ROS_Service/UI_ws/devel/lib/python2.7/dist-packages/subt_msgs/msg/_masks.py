...
"""autogenerated by genpy from subt_msgs/masks.msg. Do not edit."""
import codecs
import sys
...
class masks(genpy.Message):
  _md5sum = "30b0cc6ee1e247590a77fe90859cf2c4"
  _type = "subt_msgs/masks"
...
"""
  __slots__ = ['header','camera','count','masks','depth']
  _slot_types = ['std_msgs/Header','string','int32','subt_msgs/mask_center[]','sensor_msgs/Image']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,camera,count,masks,depth
    ...
    """
    if args or kwds:
      super(masks, self).__init__(*args, **kwds)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = subt_msgs.msg.mask_center()
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
