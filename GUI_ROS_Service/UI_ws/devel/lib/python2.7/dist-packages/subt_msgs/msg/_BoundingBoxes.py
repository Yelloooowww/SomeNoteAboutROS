...
"""autogenerated by genpy from subt_msgs/BoundingBoxes.msg. Do not edit."""
import codecs
import sys
...
class BoundingBoxes(genpy.Message):
  _md5sum = "03486b410864ff4b512ea774896cd13c"
  _type = "subt_msgs/BoundingBoxes"
...
"""
  __slots__ = ['header','camera','count','bounding_boxes','depth']
  _slot_types = ['std_msgs/Header','string','int32','subt_msgs/BoundingBox[]','sensor_msgs/Image']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,camera,count,bounding_boxes,depth
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = subt_msgs.msg.BoundingBox()
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
