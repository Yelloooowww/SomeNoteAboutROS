...
(cl:defmethod cl:initialize-instance :after ((m <pose-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'pose-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name subt_msgs-srv:<pose-request> is deprecated: use subt_msgs-srv:pose-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <pose-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'pose-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name subt_msgs-srv:<pose-response> is deprecated: use subt_msgs-srv:pose-response instead.")))

(cl:ensure-generic-function 'result-val :lambda-list '(m))
(cl:defmethod result-val ((m <pose-response>))
